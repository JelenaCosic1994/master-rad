...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_sentences_from_text(self):
        ...
        expected_senteces = ['Ja sam Jelena!', 'On upita: \"Kako se ti zoves\"?']
        self.assertEqual(expected_senteces, sentences_from_text)

    def test_load_text_from_txt(self):
        data = Parser.load_text_from_txt_file("C:\\Users\\jeca\\Desktop\\master_rad\\text.txt")
    ...
    def test_load_text_list_from_csv_file(self):
        text_list = Parser.load_text_list_from_csv_file("C:\\Users\\jeca\\Desktop\\master_rad\\SerbMR-2C.csv")
        self.assertEqual("“Ulični Psi” je jedan od onih filmova koji svedoče da je originalna ideja znatno naprednija od ogromnog "
    ...
    def test_get_all_txt_file_paths_from_dir(self):
        txt_file_paths = Parser.get_all_txt_file_paths_from_dir("C:\\Users\\jeca\\Desktop\\master_rad\\Collected_movie_reviews_in_Serbian\\")
