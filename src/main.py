...
if __name__ == '__main__':
    ...
    precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_2_classes, False, False, 'o', False)
    print("Serbian corpus - 2 classes - original serbian wordnet:\n")
    print("precision: " + str(precision) + " recall: " + str(recall) + " f measure: " + str(f_measure) + " accuracy: " + str(accuracy))

    # Serbian corpus - 2 classes - changed serbian wordnet
    precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_2_classes, False, False, 'c', False)
    print("Serbian corpus - 2 classes - changed serbian wordnet:\n")
    print("precision: " + str(precision) + " recall: " + str(recall) + " f measure: " + str(f_measure) + " accuracy: " + str(accuracy))

    # Serbian corpus - 2 classes - deleted serbian wordnet
    precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_2_classes, False, False, 'd', False)
    ...
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_2_classes, False, False, 'o', True)
    ...
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_2_classes, False, False, 'c', True)
    ...
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_2_classes, False, False, 'd', True)
    ...
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_3_classes, False, True, 'o', False)
    # print("Serbian corpus - 3 classes - original serbian wordnet:\n")
    # print("precision: " + str(precision) + " recall: " + str(recall) + " f measure: " + str(f_measure) + " accuracy: " + str(accuracy))
    #
    # # Serbian corpus - 3 classes - changed serbian wordnet
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_3_classes, False, True, 'c', False)
    # print("Serbian corpus - 3 classes - changed serbian wordnet:\n")
    # print("precision: " + str(precision) + " recall: " + str(recall) + " f measure: " + str(f_measure) + " accuracy: " + str(accuracy))
    #
    # # Serbian corpus - 3 classes - deleted serbian wordnet
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_3_classes, False, True, 'd', False)
    ...
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_3_classes, False, True, 'o', True)
    ...
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_3_classes, False, True, 'c', True)
    ...
    # precision, recall, f_measure, accuracy = wordnet_helper.calc_percents_for_corpus(serbian_corpus_3_classes, False, True, 'd', True)
    ...
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_2_classes, False, False, 'o', False)
    ...
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_2_classes, False, False, 'c', False)
    ...
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_2_classes, False, False, 'd', False)
    ...
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_2_classes, False, False, 'o', True)
    # print("SVM classifier - serbian corpus - 2 classes - original serbian wordnet where word is prefix of literal: \n" + classification_report)
    #
    # # Serbian corpus - 2 classes - svm classifier - changed serbian wordnet where word is prefix of literal
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_2_classes, False, False, 'c', True)
    # print("SVM classifier - serbian corpus - 2 classes - changed serbian wordnet where word is prefix of literal: \n" + classification_report)
    #
    # # Serbian corpus - 2 classes - svm classifier - deleted serbian wordnet where word is prefix of literal
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_2_classes, False, False, 'd', True)
    # print("SVM classifier - serbian corpus - 2 classes - deleted serbian wordnet where word is prefix of literal: \n" + classification_report)

    # # Serbian corpus - 3 classes - svm classifier - original serbian wordnet
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_3_classes, False, True, 'o', False)
    ...
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_3_classes, False, True, 'c', False)
    ...
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_3_classes, False, True, 'd', False)
    ...
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_3_classes, False, True, 'o', True)
    # print("SVM classifier - serbian corpus - 3 classes - original serbian wordnet where word is prefix of literal: \n" + classification_report)
    #
    # # Serbian corpus - 3 classes - svm classifier - original serbian wordnet where word is prefix of literal
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_3_classes, False, True, 'c', True)
    # print("SVM classifier - serbian corpus - 3 classes - changed serbian wordnet where word is prefix of literal: \n" + classification_report)
    #
    # # Serbian corpus - 3 classes - svm classifier - original serbian wordnet where word is prefix of literal
    # classification_report = svm_classifier(wordnet_helper, serbian_corpus_3_classes, False, True, 'd', True)
    # print("SVM classifier - serbian corpus - 3 classes - deleted serbian wordnet where word is prefix of literal: \n" + classification_report)